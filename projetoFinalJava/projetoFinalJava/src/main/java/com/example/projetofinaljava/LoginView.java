...
public class LoginView extends AnchorPane {
    ...
    public LoginView() {
        ...
        Label titleLabel = new Label("Entrar");
        ...
        loginButton.setStyle("-fx-font-size: 14px; -fx-padding: 8 25; -fx-background-color: #1976d2; -fx-text-fill: white; -fx-font-weight: bold; -fx-background-radius: 3;");
        registerButton = new Button("Cadastrar");
        registerButton.setStyle("-fx-font-size: 14px; -fx-padding: 8 25; -fx-background-color: #e0e0e0; -fx-font-weight: bold; -fx-background-radius: 3;");
